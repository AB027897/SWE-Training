...
const divs = view1.querySelectorSelectorAll("div");
console.log(divs);
const sameDivs = view1.getElementsByTagName("div");
console.log(sameDivs);

const evenDivs = view1.querySelectorSelectorAll("div:nth-of-type(2n)");
console.log(evenDivs);
for(let i = 0; i < evenDivs.length; i++) {
    evenDivs[i].style.background = "darkblue";
    /*evenDivs[i].style.width = "200px";
    evenDivs[1].style.height = "200px"; */
}

const navText = document.querySelection("nav h1");
console.log(navText);
...
const createDivs = (parent, iter) => {
    ...
    newDiv.style.backgroundColor = "100px";
